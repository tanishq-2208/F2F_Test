...
class OrderService {
  ...
  Future<String> createOrder({
    ...
    try {
      ...
      final orderData = {
        ...
        'quantity': quantity,
        'totalAmount': productPrice * quantity + 40.0, // Including delivery fee
  ...
  Future<List<Map<String, dynamic>>> getCustomerOrders(
    ...
    try {
      ...
      return querySnapshot.docs.map((doc) {
        ...
        return {...data, 'orderId': data['orderId'] ?? doc.id, 'docId': doc.id};
      }).toList();
    } catch (e) {
  ...
  Future<void> updateOrderStatus(String orderId, String newStatus) async {
    try {
      ...
      await _firestore
          ...
          .collection('orders')
          .doc(orderId)
          .update({'status': newStatus, 'lastUpdated': Timestamp.now()});
    } catch (e) {
  ...
  Future<List<Map<String, dynamic>>> getOldDeliveredOrders(
    BuildContext context, {
    int limit = 2,
  }) async {
    try {
  ...
  // Add this method to your OrderService class
  Future<List<Map<String, dynamic>>> getRandomDeliveredOrders(
    BuildContext context, {
    int limit = 2,
  }) async {
    try {
